        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-6">
          ...
          <div className="bru-card bru-card--raised">
            <div className="flex items-center mb-4">
              <div style={{ background: "var(--bru-purple)", padding: "8px", borderRadius: "var(--bru-radius-md)" }} className="mr-3">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="bru-progress" style={{ marginTop: "4px" }}>
                  <div className="bru-progress__bar" style={{ width: `${((analyticsData?.totalImpressions ?? 0) / 100000) * 100}%` }} />
                </div>
              </div>
              <div>
                <div className="flex items-center justify-between">
                ...
                <div className="bru-progress" style={{ marginTop: "4px" }}>
                  <div className="bru-progress__bar" style={{ width: `${((analyticsData?.ctr ?? 0) * 10)}%` }} />
                </div>
              </div>
              <div>
                <div className="flex items-center justify-between">
                ...
                <div className="bru-progress" style={{ marginTop: "4px" }}>
                  <div className="bru-progress__bar" style={{ width: `${((analyticsData?.topPerformingPillar.value ?? 0) / 50000) * 100}%` }} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bru-card bru-card--raised">
            <div className="flex items-center mb-4">
              <div style={{ background: "var(--bru-yellow)", padding: "8px", borderRadius: "var(--bru-radius-md)" }} className="mr-3">
                <PlusSquare className="text-white" size={24} />
              </div>
              <h2 className="text-lg font-bold">Quick Actions</h2>
            </div>
            <div className="space-y-3">
              <Link href="/create" className="flex items-center font-bold hover:underline" style={{ color: "var(--bru-purple)" }}>
                <ArrowUpRight size={16} className="mr-2" /> Generate New Post
              </Link>
              <Link href="/calendar" className="flex items-center font-bold hover:underline" style={{ color: "var(--bru-purple)" }}>
                <Calendar size={16} className="mr-2" /> View Calendar
              </Link>
              <Link href="/settings" className="flex items-center font-bold hover:underline" style={{ color: "var(--bru-purple)" }}>
          ...
          {/* Upcoming Posts Card */}
          <div className="bru-card bru-card--raised md:col-span-2">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-bold">Upcoming Posts</h2>
              <Link href="/calendar" className="text-sm font-bold hover:underline" style={{ color: "var(--bru-purple)" }}>View All</Link>
            </div>
            <div className="space-y-4">
              {upcomingPosts.length > 0 ? (
                upcomingPosts.map(post => (
                  <div key={post.id} className="flex items-start space-x-3 pb-4 last:pb-0" style={{ borderBottom: "1px solid rgba(0,0,0,0.08)" }}>
                    <div className="pt-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bru-card bru-card--raised">
            <div className="flex justify-between items-center mb-4">
              ...
              <Link href="/library" className="text-sm font-bold hover:underline" style={{ color: "var(--bru-purple)" }}>View Library</Link>
            </div>
            <div className="space-y-4">
            ...
            <div className="space-y-3">
              {analyticsData?.trendingTopics.length ? (
                analyticsData.trendingTopics.map((topic, index) => (
                  <div key={index} className="bru-card bru-card--flat flex items-center justify-between" style={{ padding: "8px" }}>
