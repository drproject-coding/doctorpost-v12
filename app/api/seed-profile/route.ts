  ...
  try {
    ...
    if (rows.length > 0) {
      ...
      const updatePayload = {
        ...
        perplexity_api_key: (existing.perplexity_api_key as string) || null,
        reddit_client_id: (existing.reddit_client_id as string) || null,
        reddit_client_secret: (existing.reddit_client_secret as string) || null,
      };
