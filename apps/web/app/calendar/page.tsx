    ...
    <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
      <div className="space-y-4">
        {posts.length > 0 ? posts
          ...
          .map(post => (
          <div key={post.id} className="flex items-center justify-between p-4 border-b dark:border-gray-700">
            <div>
          ...
          <p className="text-center text-gray-500 dark:text-gray-400">No posts scheduled.</p>
        )}
      </div>
    </div>
  );
        ...
        <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center space-x-2 p-1 bg-gray-200 dark:bg-gray-700 rounded-lg">
                <button 
                    ...
                    className={`px-3 py-1 rounded-md text-sm font-medium ${view === 'calendar' ? 'bg-white dark:bg-gray-900 shadow' : 'text-gray-600 dark:text-gray-300'}`}
                >
                ...
                <button 
                    ...
                    className={`px-3 py-1 rounded-md text-sm font-medium ${view === 'list' ? 'bg-white dark:bg-gray-900 shadow' : 'text-gray-600 dark:text-gray-300'}`}
                >
