...
export default function LibraryPage() {
  ...
  if (loading) {
    return <div className="p-6 text-center">Loading Content Pillars...</div>;
  }
              ...
              <div className="mt-4">
                ...
                <ul className="mt-2 space-y-1">
                  {pillar.topics.map(topic => (
                    <li key={topic} className="text-sm text-gray-600 dark:text-gray-200 bg-gray-100 dark:bg-gray-700 rounded-full px-3 py-1 inline-block mr-2 mb-2">
                      {topic}
                    </li>
                  ))}
                </ul>
