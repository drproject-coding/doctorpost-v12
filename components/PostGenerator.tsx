        ...
        <div className="post-content-container">
          {isGenerating ? (
            ...
            <div className="post-content-display">
              ...
              <textarea
                ref={contentRef}
                className={`post-content border-2 border-black rounded-bru-md p-4 bg-white w-full h-64 resize-none font-mono text-sm leading-relaxed ${isContentSelected ? "ring-2 ring-offset-2" : ""}`}
                style={
                  isContentSelected
                    ? ({
              ...
              <div className="post-generator-actions flex space-x-2 mt-4">
                <button
                  className="bru-btn bru-btn--secondary px-3 py-1 flex items-center text-sm"
