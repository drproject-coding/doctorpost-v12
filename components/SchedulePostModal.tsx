...
const SchedulePostModal: React.FC<SchedulePostModalProps> = ({
  ...
  const [selectedStatus, setSelectedStatus] = useState<PostStatus>(initialStatus);
    ...
    <div className="bru-overlay">
      <div className="bru-modal w-full max-w-md">
        ...
        <div className="bru-modal__footer">
          <button onClick={onClose} className="bru-btn bru-btn--secondary">
            Cancel
          </button>
          <button onClick={void handleSchedule} className="bru-btn bru-btn--primary">
            Schedule
          </button>
        </div>
      </div>
