...
import { getPromptById, preparePromptTemplate, generatePost } from '../lib/prompts';
...
const PostGenerator = forwardRef<PostGeneratorRef, PostGeneratorProps>(({ parameters, profile, triggerGeneration, onContentGenerated }, ref) => {
        ...
        {isGenerating ? (
          ...
          <div className="post-content-display">
            ...
            <textarea
              ...
              // The readOnly attribute allows native selection (mouse drag, Ctrl+C/Cmd+C) but prevents typing.
              // The `isContentSelected` state adds a visual ring for programmatic selection.
            ></textarea>
