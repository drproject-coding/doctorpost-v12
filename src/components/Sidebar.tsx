...
import { LayoutDashboard, PenSquare, Calendar, Book, BarChart2, Settings } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ isOpen }) => {
  const navItems = [
    ...
    { name: 'Create', path: '/create', icon: <PenSquare size={20} /> },
    { name: 'Calendar', path: '/calendar', icon: <Calendar size={20} /> },
    { name: 'Library', path: '/library', icon: <Book size={20} /> },
