...
import { getStatusColorClasses } from '../../lib/calendarUtils.js';

const CalendarView = ({ posts, onPostClick, selectedDateFromPicker }) => {
  ...
  const renderCalendar = () => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      if (isSelected) {
        cellClasses = 'bg-blazing-orange-100 border-blazing-orange';
      }
      if (isToday && isSelected) {
        cellClasses = 'bg-blazing-orange-100 border-blazing-orange ring-2 ring-purple-electric';
      }
